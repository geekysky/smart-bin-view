...
// Utility functions
function getBinFillStatus(fillLevel) {
...
function getBinStatusColor(status) {
  switch (status) {
...
function getBinFillColor(fillLevel) {
  ...
  switch (status) {
    case 'empty': return 'fill-empty';
    case 'medium': return 'fill-medium';
    case 'full': return 'fill-full';
    case 'critical': return 'fill-critical';
    default: return '';
  }
}

function getBinTypeLabel(binType) {
  switch (binType) {
